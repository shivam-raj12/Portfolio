...
import { BookOpen, Calendar, Clock, Tag, ArrowLeft, Share2, Heart, Eye } from 'lucide-react'
import Link from 'next/link'
import { useParams } from 'next/navigation'
import BlogContentRenderer from '@/components/BlogContentRenderer'
import { getBlogBySlug, type BlogPost, incrementBlogViews, incrementBlogLikes, decrementBlogLikes, parseBlogContent } from '@/lib/appwrite'
    ...
    const fetchBlog = async () => {
      ...
      try {
        ...
        if (blogData) {
          ...
          await incrementBlogViews(blogData.$id)
        } else {
